...
var requesthost = "https://www.reuters.com";
...
request(requesthost, function (error, response, body) {
  ...
  pagehead += '<title> Reuters scrape: ' + ftoday + '</title>';
  pagehead += '<link rel="stylesheet" href="../../css/astextnet.min.css">';
  pagehead += '</head><body>';
  pagehead += '<h1 class="px-5 py-3 bg-light">Reuters  - The Wire ' + ftoday + '</h1>';
  var pagefoot = '<hr></body></html>';
  var pagename = 'output/reuters/reuters_' + fntoday + '.html';
