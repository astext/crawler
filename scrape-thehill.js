...
var requesthost = "https://thehill.com";
...
request(requesthost, function (error, response, body) {
  ...
  pagehead += '<title> The Hill scrape: ' + ftoday + '</title>';
  ...
  var pagename = 'output/thehill/thehill_' + fntoday + '.html';

  fs.appendFileSync(pagename, pagehead);

  $('.top-story-item h4 a').each(function (index) {
