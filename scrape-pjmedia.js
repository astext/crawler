...
var requesthost = "https://pjmedia.com";
...
request(requesthost, function (error, response, body) {
  ...
  pagehead += '<title> PJ Media scrape: ' + ftoday + '</title>';
  pagehead += '<link rel="stylesheet" href="../../css/astextnet.min.css">';
  pagehead += '</head><body>';
  pagehead += '<h1 class="px-5 py-3 bg-light">PJ Media ' + ftoday + '</h1>';
  var pagefoot = '<hr></body></html>';
  var pagename = 'output/pjmedia/pjmedia_' + fntoday + '.html';
